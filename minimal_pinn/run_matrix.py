...
def make_tag(num_observation: int, noise_std: float) -> str:
    noise_pct = int(round(noise_std * 100))
    return f"obs{num_observation}_noise{noise_pct:03d}"
    ...
    for case_name in cases:
        ...
        for noise_std in noise_levels:
            for num_observation in observation_counts:
                ...
                tag = make_tag(num_observation, noise_std)
                ...
                print(
                    ...
                    f"obs={num_observation} noise={noise_std}",
                    flush=True,
                )
