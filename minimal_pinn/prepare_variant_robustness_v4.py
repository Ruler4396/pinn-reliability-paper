...
V3_SUITE = BASE_DIR / "variant_robustness_v3"
LOSS_BASE_SUITE = BASE_DIR / "variant_robustness_loss_adaptive_base_v1"
LOSS_FISHER_SUITE = BASE_DIR / "variant_robustness_loss_adaptive_fisher_v1"
OUTPUT_SUITE = BASE_DIR / "variant_robustness_v4"
...
def main() -> None:
    ...
    point_runs = merge_csvs(
        [
            V3_SUITE / "point_runs.csv",
            LOSS_BASE_SUITE / "point_runs.csv",
            LOSS_FISHER_SUITE / "point_runs.csv",
        ],
        OUTPUT_SUITE / "point_runs.csv",
    )
    point_summary = merge_csvs(
        [
            V3_SUITE / "point_summary.csv",
            LOSS_BASE_SUITE / "point_summary.csv",
            LOSS_FISHER_SUITE / "point_summary.csv",
        ],
