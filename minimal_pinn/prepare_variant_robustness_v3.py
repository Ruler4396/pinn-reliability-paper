...
V2_SUITE = BASE_DIR / "variant_robustness_v2"
ADAPTIVE_BASE_SUITE = BASE_DIR / "variant_robustness_adaptive_base_v1"
ADAPTIVE_FISHER_SUITE = BASE_DIR / "variant_robustness_adaptive_fisher_v1"
OUTPUT_SUITE = BASE_DIR / "variant_robustness_v3"
...
def main() -> None:
    ...
    point_runs = merge_csvs(
        [
            V2_SUITE / "point_runs.csv",
            ADAPTIVE_BASE_SUITE / "point_runs.csv",
            ADAPTIVE_FISHER_SUITE / "point_runs.csv",
        ],
        OUTPUT_SUITE / "point_runs.csv",
    )
    point_summary = merge_csvs(
        [
            V2_SUITE / "point_summary.csv",
            ADAPTIVE_BASE_SUITE / "point_summary.csv",
            ADAPTIVE_FISHER_SUITE / "point_summary.csv",
        ],
