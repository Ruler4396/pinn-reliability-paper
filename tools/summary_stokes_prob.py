"""Quick summary generator for Stokes probability boundary matrix."""
import json, statistics
from pathlib import Path
from itertools import groupby

runs_dir = Path("minimal_pinn/results/probability_matrices/stokes_probability_boundary_v1/runs")
rows = []
